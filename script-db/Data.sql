...
GIATIEN INT);
INSERT INTO LOAIPHONG VALUES ('GUARANTEE',2000000);
INSERT INTO LOAIPHONG VALUES ('NOT GUARANTEE',1000000);
...
ALTER TABLE PHIEUDATPHONG
ADD CONSTRAINT FK_PHIEUDATPHONG_LOAIPHONG
...
ALTER TABLE PHIEUDANGKYVANCHUYEN
ADD CONSTRAINT FK_PHIEUDANGKYVANCHUYEN_PHIEUDATPHONG_PHIEUDP
FOREIGN KEY (MA_PHIEU_DP) REFERENCES PHIEUDATPHONG(MA_PHIEU_DP)

ALTER TABLE PHIEUDANGKYVANCHUYEN
ADD CONSTRAINT FK_PHIEUDANGKYVANCHUYEN_PHONG_MAPHONG 
FOREIGN KEY (MA_PHONG) REFERENCES PHONG(MA_PHONG)
...
ADD CONSTRAINT FK_PHANCONGDONVESINH_NHANVIEN_BELLMAN
FOREIGN KEY (MA_NVBELLMAN) REFERENCES NHANVIEN(MA_NV)

ALTER TABLE PHANCONGDONVESINH
ADD CONSTRAINT FK_PHANCONGDONVESINH_NHANVIEN_VS
FOREIGN KEY (MA_NVVS) REFERENCES NHANVIEN(MA_NV)
...
ALTER TABLE PHIEUDATPHONG
ADD CONSTRAINT FK_PHIEUDATPHONG_GOIDICHVU
FOREIGN KEY (MA_GOIDV) REFERENCES GOIDICHVU(MA_GOIDV)
...
ALTER TABLE DICHVUKHACHSAN
ADD LOAI NVARCHAR(1000);
...
INSERT INTO DICHVUKHACHSAN VALUES('DV004','Beer',50000,'Grocery at A3','SP');


UPDATE DICHVUKHACHSAN SET MOTA = N'Làm đẹp cho cơ thể của bạn' WHERE MA_DV = 'DV001'
UPDATE DICHVUKHACHSAN SET MOTA = N'Rèn luyện sức khỏe' WHERE MA_DV = 'DV002'
UPDATE DICHVUKHACHSAN SET MOTA = N'Rèn luyện sức khỏe' WHERE MA_DV = 'DV003'
UPDATE DICHVUKHACHSAN SET MOTA = N'Bia 333' WHERE MA_DV = 'DV004'

INSERT INTO DICHVUKHACHSAN VALUES('DV005','Buffet',200000,'B51','DVKS','Tiệc buffet 5 sao');


INSERT INTO GOIDICHVU VALUES('G0001',200000)

INSERT INTO CHITIETGDV VALUES('G0001','DV001',10);
INSERT INTO CHITIETGDV VALUES('G0001','DV005',5);
INSERT INTO CHITIETGDV VALUES('G0001','DV003',5);

INSERT INTO PHIEUDATPHONG VALUES('P0001',NULL,NULL,NULL,NULL,NULL,NULL,'G0001',NULL);

UPDATE PHIEUDATPHONG SET MA_KH ='KH001'

SELECT * FROM PHIEUDATPHONG
SELECT * FROM KHACHHANG

INSERT INTO KHACHHANG VALUES('KH001','NGUYEN VAN A','5573826','52 MCT, Q1,HCM','0939643777',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL)