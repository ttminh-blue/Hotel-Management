...
const BaggageFormManage = (props: Props) => {
   const baggageFormsQuery = useQuery<BaggageFormType[]>(
      "baggage_requests",
      async () =>
         (
            await axios.get(
               process.env.NEXT_PUBLIC_API + "Bellman/baggage_requests"
            )
         ).data
   );
   ...
   return (
      <DefaultLayout>
         <section className="bg-gray-50 dark:bg-gray-900 py-3 sm:py-5">
            <div className="px-2 mx-auto max-w-screen-2xl lg:px-4">
               <div className="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                  ...
                  <div className="overflow-x-auto">
                     <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                           {baggageFormsQuery.isSuccess &&
                              baggageFormsQuery.data.map((item, index) => {
                                 return (
                                    <RowTableBaggageForms
                                       item={item}
                                       key={index}
                                    />
                                 );
...
export default BaggageFormManage;
